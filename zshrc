...
if [ "$color_prompt" = yes ]; then
    PROMPT="%B%F{%(#.blue.green)}%n@%m%F{%(#.white.grey)}:%F{%(#.white.blue)}%~%F{%(#.white.grey)}%b$ "
...
alias avrdude='avrdude -C/home/sam/opt/arduino/hardware/tools/avr/etc/avrdude.conf'
alias looking-glass-client='looking-glass-client -m 97'
...
export PATH=$PATH:'/home/sam/opt/cross/bin'
